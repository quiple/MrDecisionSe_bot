...
const keywordList = [
  ...
  { // 할까 (말까)
    keyword: /(?<!야\s?)((?:[^\s될뭘을일]+|([^갔깠났닸땄랐맜밨빴샀쌌았잤짰찼탔팠갰깼냈댔땠랬맸뱄뺐샜쌨앴쟀쨌챘캤탰팼했얐얬헀겄껐넜떴렀멌벘뻤섰썼었젔쩠첬컸텄펐겠넸뎄뗐렜멨벴셌엤켔헸겼꼈녔뎠뗬렸몄볐뼜셨였졌쪘쳤켰텼폈혔곘옜괐꽜놨뫘봤쐈왔쫬홨괬꽸뇄됐뙜뢨뫴뵀쇘쐤왰좼쬈됬뵜쇴쑀욌붔궜꿨눴뒀뤘뭤붰쉈쒔웠줬쭸췄퉜궸뀄뒸뜄윘뀼읬깄낐딨맀밌빘싰씼있짔칬킸핐힜]을))까)(?:\S*\??$|\s?말까\S*\??$)/,
    behavior: 'pickOne',
    parameter: ['(아/어)', '지 마', '(아/어)라 좀', '지 말지', '자', '지 말자', '(아/어)라', '지 말어', ('려고?', '으려고?'), '(아/어)야겠냐?'],
  },
  { // 인가/일까
