const explicitCommands = [
  ...
  { command: /^김경절!+\s?/, behavior: "customPick" },
  ...
  { command: /^긴결정!+\s?/, behavior: "customPick" },
  { command: /^긴결전!+\s?/, behavior: "customPick" },
  { command: /^긴경정!+\s?/, behavior: "customPick" },
  { command: /^긴경절!+\s?/, behavior: "customPick" },
];
...
const nieun = "간깐난단딴란만반빤산싼안잔짠찬칸탄판한갠깬낸댄땐랜맨밴뺀샌쌘앤잰짼챈캔탠팬핸갼꺈냔댠땬랸먄뱐뺜샨쌴얀쟌쨘챤캰탼퍈햔걘꺤냰댼떈럔먠뱬뺸섄썐얜쟨쨴첀컌턘퍤햰건껀넌던떤런먼번뻔선썬언전쩐천컨턴펀헌겐껜넨덴뗀렌멘벤뻰센쎈엔젠쩬첸켄텐펜헨견껸년뎐뗜련면변뼌션쎤연젼쪈쳔켠텬편현곈꼔녠뎬뗸롄몐볜뼨셴쏀옌졘쪤쳰켼톈폔혠곤꼰논돈똔론몬본뽄손쏜온존쫀촌콘톤폰혼관꽌놘돤똰롼뫈봔뽠솬쏸완좐쫜촨콴퇀퐌환괜꽨놴됀뙌뢘뫤봰뽼쇈쐔왠좬쫸쵄쾐퇜퐨홴괸꾄뇐된뙨뢴묀뵌뾘쇤쐰왼죈쬔쵠쾬퇸푄횐굔꾠뇬됸뚄룐묜뵨뾴숀쑌욘죤쬰쵼쿈툔푠횬군꾼눈둔뚠룬문분뿐순쑨운준쭌춘쿤툰푼훈권꿘눤둰뚼뤈뭔붠뿬숸쒄원줜쭨춴퀀퉌풘훤궨꿴뉀뒌뛘뤤뭰붼쀈쉔쒠웬줸쮄췐퀜퉨풴휀귄뀐뉜뒨뛴륀뮌뷘쀤쉰쒼윈쥔쮠췬퀸튄퓐휜균뀬뉸듄뜐륜뮨뷴쁀슌쓘윤쥰쮼츈큔튠퓬휸근끈는든뜬른믄븐쁜슨쓴은즌쯘츤큰튼픈흔긘끤늰듼띈릔믠븬쁸싄씐읜즨쯴칀킌틘픤흰긴낀닌딘띤린민빈삔신씬인진찐친킨틴핀힌";

const rieul = "갈깔날달딸랄말발빨살쌀알잘짤찰칼탈팔할갤깰낼댈땔랠맬밸뺄샐쌜앨잴쨀챌캘탤팰핼걀꺌냘댤땰랼먈뱔뺠샬쌸얄쟐쨜챨캴턀퍌햘걜꺨냴덀떌럘먤뱰뺼섈썔얠쟬쨸첄컐턜퍨햴걸껄널덜떨럴멀벌뻘설썰얼절쩔철컬털펄헐겔껠넬델뗄렐멜벨뻴셀쎌엘젤쩰첼켈텔펠헬결껼녈뎔뗠렬멸별뼐셜쎨열졀쪌쳘켤텰펼혈곌꼘녤뎰뗼롈몔볠뼬셸쏄옐졜쪨쳴콀톌폘혤골꼴놀돌똘롤몰볼뽈솔쏠올졸쫄촐콜톨폴홀괄꽐놜돨똴뢀뫌봘뽤솰쏼왈좔쫠촬콸퇄퐐활괠꽬놸됄뙐뢜뫨봴뾀쇌쐘왤좰쫼쵈쾔퇠퐬홸괼꾈뇔될뙬뢸묄뵐뾜쇨쐴욀죌쬘쵤쾰퇼푈횔굘꾤뇰됼뚈룔묠뵬뾸숄쑐욜죨쬴춀쿌툘푤횰굴꿀눌둘뚤룰물불뿔술쑬울줄쭐출쿨툴풀훌궐꿜눨둴뛀뤌뭘붤뿰숼쒈월줠쭬춸퀄퉐풜훨궬꿸뉄뒐뛜뤨뭴뷀쀌쉘쒤웰줼쮈췔퀠퉬풸휄귈뀔뉠뒬뛸륄뮐뷜쀨쉴쓀윌쥘쮤췰퀼튈퓔휠귤뀰뉼듈뜔률뮬뷸쁄슐쓜율쥴쯀츌큘튤퓰휼글끌늘들뜰를믈블쁠슬쓸을즐쯜츨클틀플흘긜끨늴딀띌릘믤븰쁼싈씔읠즬쯸칄킐틜픨흴길낄닐딜띨릴밀빌삘실씰일질찔칠킬틸필힐";

const keywordList = [
  { keyword: `(\S+)냐(?:\?|\S*$)`, behavior: "pickOne", parameter: ["$야지", "$지 마", "$야 돼", "안 $도 돼", "$야 돼", "$지 말든지"] },
  { keyword: `(\S*[${rieul}])까(?:\?|\S*$)`, behavior: "pickOne", parameter: ["$야지", "$지 마", "$야 돼", "안 $도 돼", "$야 돼", "$지 말든지"] },
  ...
  { keyword: /어떰\?/, behavior: "pickOne", parameter: ["굳", "노굳", "괜찮네", "ㄴㄴ", "좋으다", "그닥.."] },
  { keyword: /어떻냐(?:\?|\S*$)/, behavior: "pickOne", parameter: ["굳", "노굳", "괜찮네", "ㄴㄴ", "좋으다", "그닥.."] },
  { keyword: /워뗘(?:\?|\S*$)/, behavior: "pickOne", parameter: ["굳", "노굳", "괜찮네", "ㄴㄴ", "좋으다", "그닥.."] },
  ...
  { keyword: /김결쩡/, behavior: "fallback" },
  { keyword: /깅결정/, behavior: "fallback" },
  { keyword: /김결전/, behavior: "fallback" },
  { keyword: /김경절/, behavior: "fallback" },
  { keyword: /심결정/, behavior: "fallback" },
  { keyword: /김굘정/, behavior: "fallback" },
  { keyword: /김경정/, behavior: "fallback" },
  { keyword: /김경전/, behavior: "fallback" },
  { keyword: /김결잔/, behavior: "fallback" },
  { keyword: /긴결정/, behavior: "fallback" },
  { keyword: /긴결전/, behavior: "fallback" },
  { keyword: /긴경정/, behavior: "fallback" },
  { keyword: /긴경절/, behavior: "fallback" },
];
...
const irregularTable = [
  ...
  /* $냐 */ { pattern: /하$/, fix: "해" },
  /* $냐 */ { pattern: /하라$/, fix: "해라" },
  /* $까 */ { pattern: /할((?:야지|라))$/, fix: "해$" },
  /* $까 */ { pattern: /할((?:자|지 마))$/, fix: "하$" },
